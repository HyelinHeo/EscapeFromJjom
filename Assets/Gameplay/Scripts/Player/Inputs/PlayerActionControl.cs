// GENERATED AUTOMATICALLY FROM 'Assets/Gameplay/Scripts/Player/Inputs/RPGFREEInputActions.inputactions'
...
public class @PlayerActionControl : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""SpeedUp"",
                    ""type"": ""Value"",
                    ""id"": ""8690cce6-6280-41c9-818f-f8d9bf833a2c"",
                ...
                },
                {
                    ""name"": ""Mouse"",
                    ""type"": ""Value"",
                    ""id"": ""4e34818c-486b-4afc-a277-1e3cd35952aa"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""9955bd93-357b-4fc4-8b42-2e87bda41797"",
                    ""path"": ""<Keyboard>/z"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""44e0b565-bff1-42a3-a6bb-e76388fe65d4"",
                    ""path"": ""<Keyboard>/x"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""588f70d4-221b-446a-bc29-7efca5c07997"",
                ...
                {
                    ""name"": """",
                    ""id"": ""c98422c8-b424-49f2-98e9-a05864c775f0"",
                    ""path"": ""<Keyboard>/ctrl"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""2552c899-3fb1-46a2-b1e9-7d8e5e3aeb51"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ef496bc3-5681-4a95-a274-bab95e3b384b"",
                    ""path"": ""<Pointer>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_RPGCharacter_SpeedUp = m_RPGCharacter.FindAction("SpeedUp", throwIfNotFound: true);
        m_RPGCharacter_Mouse = m_RPGCharacter.FindAction("Mouse", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_RPGCharacter_SpeedUp;
    private readonly InputAction m_RPGCharacter_Mouse;
    public struct RPGCharacterActions
    {
        private @PlayerActionControl m_Wrapper;
        public RPGCharacterActions(@PlayerActionControl wrapper) { m_Wrapper = wrapper; }
        ...
        public InputAction @SpeedUp => m_Wrapper.m_RPGCharacter_SpeedUp;
        public InputAction @Mouse => m_Wrapper.m_RPGCharacter_Mouse;
        ...
        public void SetCallbacks(IRPGCharacterActions instance)
        {
            if (m_Wrapper.m_RPGCharacterActionsCallbackInterface != null)
            {
                ...
                @SpeedUp.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnSpeedUp;
                @SpeedUp.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnSpeedUp;
                @SpeedUp.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnSpeedUp;
                @Mouse.started -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnMouse;
                @Mouse.performed -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnMouse;
                @Mouse.canceled -= m_Wrapper.m_RPGCharacterActionsCallbackInterface.OnMouse;
            }
